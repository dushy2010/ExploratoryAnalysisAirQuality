...
if(!exists("NEI")){
    NEI <- readRDS("/Users/dchillal/Downloads/Coursera/exdata_data_NEI_data/summarySCC_PM25.rds")
}
if(!exists("SCC")){
    SCC <- readRDS("/Users/dchillal/Downloads/Coursera/exdata_data_NEI_data/Source_Classification_Code.rds")
}
